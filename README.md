...
I adapted the same conda environment for both RAG and Ribodiffusion. DRfold2, however, I installed in a Docker container running Ubuntu 22.04, due to the ARENA package requiring Linux for compilation. 
* Install DRfold2:
```
